...
import ExampleUpdateComponent from '@/entities/example/example-update.vue';
import ExampleClass from '@/entities/example/example-update.component';
...
describe('Component Tests', () => {
  describe('Example Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ExampleClass>(ExampleUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.example = entity;
        exampleServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(exampleServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.example = entity;
        exampleServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(exampleServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        exampleServiceStub.retrieve.resolves([foundExample]);
