...
export default class SystemParam extends Vue {
  ...
  public retrieveAllSystemParams(): void {
  ...
  public prepareRemove(instance: ISystemParam): void {
  ...
  public removeSystemParam(): void {
    this.systemParamService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('moneyMakingMachineApp.systemParam.deleted', { param: this.removeId });
