...
export default class DataPermissionDetails extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllDataPermissionDetailss();
  }
  ...
  public retrieveAllDataPermissionDetailss(): void {
    ...
    this.dataPermissionDetailsService()
      ...
      .then(
        res => {
          this.dataPermissionDetails = res.data;
  ...
  public prepareRemove(instance: IDataPermissionDetails): void {
  ...
  public removeDataPermissionDetails(): void {
    this.dataPermissionDetailsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('moneyMakingMachineApp.dataPermissionDetails.deleted', { param: this.removeId });
