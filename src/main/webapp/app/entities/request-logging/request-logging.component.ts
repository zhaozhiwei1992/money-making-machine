...
export default class RequestLogging extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllRequestLoggings();
  }
  ...
  public retrieveAllRequestLoggings(): void {
  ...
  public prepareRemove(instance: IRequestLogging): void {
  ...
  public removeRequestLogging(): void {
    this.requestLoggingService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('moneyMakingMachineApp.requestLogging.deleted', { param: this.removeId });
