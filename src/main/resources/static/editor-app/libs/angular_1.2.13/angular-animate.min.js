      ...
      function ($, h) {
        ...
        $.decorator('$animate', [
          ...
          function (x, z, ca, F, J, B, T) {
            ...
            function t(a, c, e, d, k, C, s) {
              ...
              function n(b, g, ja) {
                ...
                D(b, function (d, f) {
                  ...
                  'before' != g || ('enter' != a && 'move' != a)
                    ? d[g]
                      ? (d[fa] = F ? d[g](e, E, z, A) : m ? d[g](e, c, A) : d[g](e, A))
                      : A()
                    : A();
                });
              }
              ...
              if (y && W(v)) {
                var u = f.element._data(y),
                  u = u && u.events,
                  y = (' ' + v).replace(/\s+/g, '.');
                d || (d = k ? k.parent() : e.parent());
                var q = V(y),
                  m = 'addClass' == a || 'removeClass' == a || F,
                  I = e.data(l) || {};
                k = I.active || {};
                y = I.totalActive || 0;
                v = I.last;
                if (R(e, d) || 0 === q.length) K(), x(), H(), G();
                else {
                  var L = [];
                  (m && (I.disabled || (v && !v.classBased))) ||
                    D(q, function (b) {
                      if (!b.allowCancel || b.allowCancel(e, a, c)) {
                        var g = b[a];
                        'leave' == a ? ((b = g), (g = null)) : (b = b['before' + a.charAt(0).toUpperCase() + a.substr(1)]);
                        L.push({ before: b, after: g });
                      }
                    });
                  if (0 === L.length) K(), x(), H(), B();
                  else {
                    d = !1;
                    if (0 < y) {
                      q = [];
                      if (m)
                        'setClass' == v.event ? (q.push(v), M(e, c)) : k[c] && ((N = k[c]), N.event == a ? (d = !0) : (q.push(N), M(e, c)));
                      else if ('leave' == a && k['ng-leave']) d = !0;
                      else {
                    ...
                    if (d) x(), H(), B();
                      ...
                      y++;
                      k[c] = v;
                      e.data(l, { last: v, active: k, index: Q, totalActive: y });
                      n(L, 'before', t);
                    }
                  }
                }
            ...
            function M(a, c) {
              if (d(a) == d(F)) s.disabled || ((s.running = !1), (s.structural = !1));
              else if (c) {
                var e = a.data(l) || {},
                  f = !0 === c;
                !f && e.active && e.active[c] && (e.totalActive--, delete e.active[c]);
            ...
            function R(a, c) {
              ...
              do {
                ...
                var e = d(c) == d(F),
                  f = e ? s : c.data(l),
                  f = f && (!!f.disabled || f.running || 0 < f.totalActive);
                if (e || f) return f;
                if (e) break;
              } while ((c = c.parent()));
              return !0;
        ...
        h.register('', [
          ...
          function (l, s, h, n) {
            ...
            function M(b, a, c) {
              'ng-enter' != a && 'ng-move' != a && 'ng-leave' != a && c ? b.addClass(ga) : (d(b).style[O + H] = 'none');
            }
            function R(b, a) {
              var c = O + H,
                e = d(b);
            ...
            function Z(b, a, c, e) {
              ...
              if (-1 != h.className.indexOf(c) && b) {
                ...
                var p = b.stagger,
                  r = b.timings,
                  n = b.itemIndex,
                  s = Math.max(r.transitionDuration, r.animationDuration),
                  t = Math.max(r.transitionDelay, r.animationDelay),
                  u = t * y,
                  x = Date.now(),
                  w = ba + ' ' + aa,
                  m = '',
                ...
                if (0 < r.transitionDuration) {
                  ...
                  -1 == z.indexOf('all') &&
                    ((m += C + 'transition-property: ' + z + ';'),
                    (m += C + 'transition-duration: ' + r.transitionDurationStyle + ';'),
                    q.push(C + 'transition-property'),
                    q.push(C + 'transition-duration'));
                }
                0 < n &&
                  (0 < p.transitionDelay &&
                    0 === p.transitionDuration &&
                    ((m += C + 'transition-delay: ' + W(r.transitionDelayStyle, p.transitionDelay, n) + '; '),
                    q.push(C + 'transition-delay')),
                  0 < p.animationDelay &&
                    0 === p.animationDuration &&
                    ((m += C + 'animation-delay: ' + W(r.animationDelayStyle, p.animationDelay, n) + '; '), q.push(C + 'animation-delay')));
            ...
            var C = '',
              ...
              P,
              ba;
            z.ontransitionend === T && z.onwebkittransitionend !== T
              ? ((C = '-webkit-'), (O = 'WebkitTransition'), (aa = 'webkitTransitionEnd transitionend'))
              : ((O = 'transition'), (aa = 'transitionend'));
            z.onanimationend === T && z.onwebkitanimationend !== T
              ? ((C = '-webkit-'), (P = 'WebkitAnimation'), (ba = 'webkitAnimationEnd animationend'))
            ...
            var ea = 'Duration',
              ...
              G = '$$ngAnimateKey',
              E = '$$ngAnimateCSS3Data',
              ga = 'ng-animate-block-transitions',
              $ = 3,
              v = 1.5,
              y = 1e3,
              u = {},
            ...
            return {
              ...
              beforeSetClass: function (b, c, d, e) {
                var f = k(d, '-remove') + ' ' + k(c, '-add'),
                  h = a('setClass', b, f, function (a) {
                    var e = b.attr('class');
                    b.removeClass(d);
                    b.addClass(c);
                    a = a();
              ...
              beforeRemoveClass: function (b, c, d) {
                var e = a('removeClass', b, k(c, '-remove'), function (a) {
                  var d = b.attr('class');
                  b.removeClass(c);
                  a = a();
                  b.attr('class', d);
