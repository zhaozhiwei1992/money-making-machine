...
(function (a) {
  ...
  function $(a) {
    ...
    return null === b
      ...
      : ('string' == typeof b && (a._i = b = C().preparse(b)),
        db.isMoment(b) ? ((a = i(b)), (a._d = new Date(+b._d))) : c ? (m(c) ? Q(a) : N(a)) : S(a),
        new f(a));
  }
  function _(a, b) {
  ...
  for (
    var db,
      ...
      ob = 6,
      pb = {},
      qb = { _isAMomentObject: null, _i: null, _f: null, _l: null, _strict: null, _isUTC: null, _offset: null, _pf: null, _lang: null },
      rb = 'undefined' != typeof module && module.exports && 'undefined' != typeof require,
      sb = /^\/?Date\((\-?\d+)/i,
      tb = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,
      ...
      Sb = { Milliseconds: 1, Seconds: 1e3, Minutes: 6e4, Hours: 36e5, Days: 864e5, Months: 2592e6, Years: 31536e6 },
      Tb = {
        ms: 'millisecond',
        s: 'second',
        m: 'minute',
      ...
      Ub = { dayofyear: 'dayOfYear', isoweekday: 'isoWeekday', isoweek: 'isoWeek', weekyear: 'weekYear', isoweekyear: 'isoWeekYear' },
      Vb = {},
  ...
  for (
    Yb.DDDD = c(Yb.DDD, 3),
      ...
      db.duration = function (a, b) {
        ...
        return (
          db.isDuration(a)
            ...
            : (h = tb.exec(a))
            ? ((c = '-' === h[1] ? -1 : 1),
              (f = { y: 0, d: s(h[kb]) * c, h: s(h[lb]) * c, m: s(h[mb]) * c, s: s(h[nb]) * c, ms: s(h[ob]) * c }))
            : (h = ub.exec(a)) &&
              ((c = '-' === h[1] ? -1 : 1),
              (e = function (a) {
              ...
              (f = { y: e(h[2]), M: e(h[3]), d: e(h[4]), h: e(h[5]), m: e(h[6]), s: e(h[7]), w: e(h[8]) })),
          (d = new g(f)),
      ...
      db.lang = function (a, b) {
        var c;
        return a
          ? (b ? A(y(a), b) : null === b ? (B(a), (a = 'en')) : pb[a] || C(a), (c = db.duration.fn._lang = db.fn._lang = C(a)), c._abbr)
          : db.fn._lang._abbr;
      },
