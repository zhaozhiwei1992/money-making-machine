(function (e, t) {
  ...
  var p = angular.module('ngGrid.directives', []),
    m = angular.module('ngGrid.filters', []);
    ...
    if (e.enableCellSelection) {
      ...
      if (37 === l || (9 === l && o.shiftKey)) {
        ...
        u || (r -= 1),
          f
            ? u && 9 === l && o.shiftKey
              ? ((v = i.$canvas.width()), (r = g.length - 1), (s = !0))
              : (v = i.$viewport.scrollLeft() - e.col.width)
            : d.length > 0 && (v = i.$viewport.scrollLeft() - g[r].width),
          i.$viewport.scrollLeft(v);
      } else
        (39 === l || (9 === l && !o.shiftKey)) &&
          (h
            ? p && 9 === l && !o.shiftKey
              ? (i.$viewport.scrollLeft(0), (r = e.showSelectionCheckbox ? 1 : 0), (a = !0))
              : i.$viewport.scrollLeft(i.$viewport.scrollLeft() + e.col.width)
            : m && i.$viewport.scrollLeft(0),
          p || (r += 1));
    }
    var w;
    w =
      e.configGroups.length > 0
        ? i.rowFactory.parsedData.filter(function (e) {
            return !e.isAggRow;
          })
        : i.filteredRows;
    var C = 0;
    if (
      (0 !== c && (38 === l || (13 === l && o.shiftKey) || (9 === l && o.shiftKey && s))
        ? (C = -1)
        : c !== w.length - 1 && (40 === l || (13 === l && !o.shiftKey) || (9 === l && a)) && (C = 1),
      C)
    ) {
      var b = w[c + C];
      b.beforeSelectionChange(b, o) &&
        (b.continueSelection(o),
        e.$emit('ngGridEventDigestGridParent'),
        e.selectionProvider.lastClickedRow.renderedRowIndex >= e.renderedRows.length - n - 2
          ? i.$viewport.scrollTop(i.$viewport.scrollTop() + e.rowHeight)
          : n + 2 >= e.selectionProvider.lastClickedRow.renderedRowIndex && i.$viewport.scrollTop(i.$viewport.scrollTop() - e.rowHeight));
    }
    return (
        ...
        var n = {},
          ...
          i = function () {
            ...
            e.appendTo('body'),
              ...
              (n.ScrollW = e.width() - e[0].clientWidth),
              e.empty(),
              e.attr('style', ''),
              e.append('<span style="font-family: Verdana, Helvetica, Sans-Serif; font-size: 14px;"><strong>M</strong></span>'),
              (n.LetterW = e.children().first().width()),
              e.remove();
          };
        return (
          (n.eventStorage = {}),
          (n.AssignGridContainers = function (e, o, i) {
            (i.$root = t(o)),
          ...
          (n.getRealWidth = function (e) {
            var n = 0,
              o = { visibility: 'hidden', display: 'block' },
              i = e.parents().andSelf().not(':visible');
            return (
              t.swap(i[0], o, function () {
                n = e.outerWidth();
              }),
              n
            );
          ...
          (n.UpdateGridLayout = function (e, t) {
            ...
            (t.elementDims.rootMaxW = t.$root.width()),
              t.$root.is(':hidden') && (t.elementDims.rootMaxW = n.getRealWidth(t.$root)),
              (t.elementDims.rootMaxH = t.$root.height()),
              t.refreshDomSizes(),
              e.adjustScrollTop(o, !0);
          }),
          (n.numberOfGrids = 0),
          (n.BuildStyles = function (o, i, r) {
            var l,
              a = i.config.rowHeight,
              s = i.$styleSheet,
              c = i.gridId,
              g = o.columns,
              d = 0;
            s || ((s = t('#' + c)), s[0] || (s = t("<style id='" + c + "' type='text/css' rel='stylesheet' />").appendTo(i.$root))),
              s.empty();
            ...
            e.isIe ? (s[0].styleSheet.cssText = l) : s[0].appendChild(document.createTextNode(l)),
              (i.$styleSheet = s),
              o.adjustScrollLeft(i.$viewport.scrollLeft()),
              r && n.digest(o);
          }),
          ...
          (n.setColLeft.immediate = 1),
          (n.RebuildGrid = function (e, t) {
            n.UpdateGridLayout(e, t),
              (null == t.config.maintainColumnRatios || t.config.maintainColumnRatios) && t.configureColumnWidths(),
              e.adjustScrollLeft(t.$viewport.scrollLeft()),
              n.BuildStyles(e, t, !0);
          }),
          (n.digest = function (e) {
        ...
        return (
          ...
          (t.sortNumberStr = function (e, t) {
            var n,
              ...
              r = !1;
            return (
              (n = parseFloat(e.replace(/[^0-9.-]/g, ''))),
              isNaN(n) && (i = !0),
              (o = parseFloat(t.replace(/[^0-9.-]/g, ''))),
              isNaN(o) && (r = !0),
              i && r ? 0 : i ? 1 : r ? -1 : n - o
            );
          }),
          ...
          (t.getSortFn = function (n, o) {
            ...
            else if (void 0 !== n.sortingAlgorithm) (i = n.sortingAlgorithm), (t.colSortFnCache[n.field] = n.sortingAlgorithm);
            else {
              if (((r = o[0]), !r)) return i;
          ...
          i = {
            visualLength: function (e) {
              ...
              return (
                ...
                t(n).css('font', t(e).css('font')),
                t(n).css('font-size', t(e).css('font-size')),
                t(n).css('font-family', t(e).css('font-family')),
                (n.innerHTML = t(e).text()),
                n.offsetWidth
              );
            },
            forIn: function (e, t) {
  ...
  var w = function (e, t, n, o) {
    (this.rowIndex = 0),
      (this.offsetTop = this.rowIndex * n),
      (this.entity = e),
      (this.label = e.gLabel),
      (this.field = e.gField),
      (this.depth = e.gDepth),
  ...
  (w.prototype.toggleExpand = function () {
    ...
    (w.prototype.notifyChildren = function () {
      for (var e = Math.max(this.rowFactory.aggCache.length, this.children.length), t = 0; e > t; t++)
        if (
          (this.aggChildren[t] &&
            ((this.aggChildren[t].entity[s] = this.collapsed), this.collapsed && this.aggChildren[t].setExpand(this.collapsed)),
          this.children[t] && (this.children[t][s] = this.collapsed),
          t > this.aggIndex && this.rowFactory.aggCache[t])
        ) {
          var n = this.rowFactory.aggCache[t],
    ...
    (w.prototype.totalChildren = function () {
      if (this.aggChildren.length > 0) {
        var e = 0,
          t = function (n) {
            n.aggChildren.length > 0
              ? angular.forEach(n.aggChildren, function (e) {
                  t(e);
                })
              : (e += n.children.length);
          };
  ...
  var C = function (e, n, o, l, a, s) {
      ...
      (c.colDef = e.colDef),
        ...
        c.enableCellEdit &&
          ((c.cellEditTemplate = a.get('cellEditTemplate.html')),
          (c.editableCellTemplate = d.editableCellTemplate || a.get('editableCellTemplate.html'))),
        d.cellTemplate &&
          !h.test(d.cellTemplate) &&
          (c.cellTemplate = t.ajax({ type: 'GET', url: d.cellTemplate, async: !1 }).responseText),
        c.enableCellEdit &&
          d.editableCellTemplate &&
          !h.test(d.editableCellTemplate) &&
          (c.editableCellTemplate = t.ajax({ type: 'GET', url: d.editableCellTemplate, async: !1 }).responseText),
        d.headerCellTemplate &&
          !h.test(d.headerCellTemplate) &&
          (c.headerCellTemplate = t.ajax({ type: 'GET', url: d.headerCellTemplate, async: !1 }).responseText),
        (c.colIndex = function () {
        ...
        (c.gripClick = function () {
          f++,
            1 === f
              ...
              : (clearTimeout(p), e.resizeOnDataCallback(c), (f = 0));
        }),
        (c.gripOnMouseDown = function (e) {
          return (
            (n.isColumnResizing = !0),
            e.ctrlKey && !c.pinned
              ? (c.toggleVisible(), l.BuildStyles(n, o), !0)
              : ((e.target.parentElement.style.cursor = 'col-resize'),
                (c.startMousePosition = e.clientX),
                (c.origWidth = c.width),
                t(document).mousemove(c.onMouseMove),
                t(document).mouseup(c.gripOnMouseUp),
                !1)
          );
        }),
        (c.onMouseMove = function (e) {
          var t = e.clientX - c.startMousePosition,
            i = t + c.origWidth;
          return (
            (c.width = c.minWidth > i ? c.minWidth : i > c.maxWidth ? c.maxWidth : i),
            (n.hasUserChangedGridColumnWidths = !0),
            l.BuildStyles(n, o),
            !1
          );
        }),
        (c.gripOnMouseUp = function (e) {
          return (
            t(document).off('mousemove', c.onMouseMove),
            t(document).off('mouseup', c.gripOnMouseUp),
            (e.target.parentElement.style.cursor = 'default'),
            l.digest(n),
            (n.isColumnResizing = !1),
            !1
          );
        }),
        (c.copy = function () {
    ...
    (S.prototype.focusCellElement = function (e, t) {
      if (e.selectionProvider.lastClickedRow) {
        var n = void 0 !== t ? t : this.previousColumn,
          o = e.selectionProvider.lastClickedRow.clone
  ...
  var x = function (n, o, i, r) {
      ...
      (l.colToMove = void 0),
        ...
        (l.assignEvents = function () {
          n.config.jqueryUIDraggable && !n.config.enablePinning
            ...
            : (n.$groupPanel.on('mousedown', l.onGroupMouseDown).on('dragover', l.dragOver).on('drop', l.onGroupDrop),
              n.$headerScroller.on('mousedown', l.onHeaderMouseDown).on('dragover', l.dragOver),
              n.config.enableColumnReordering && !n.config.enablePinning && n.$headerScroller.on('drop', l.onHeaderDrop)),
            o.$watch('renderedColumns', function () {
              r(l.setDraggables);
            });
        }),
          ...
          if (n.config.jqueryUIDraggable)
            ...
            angular.forEach(e, function (e) {
              e.className &&
                ...
                (e.setAttribute('draggable', 'true'), e.addEventListener && e.addEventListener('dragstart', l.dragStart));
            }),
              -1 !== navigator.userAgent.indexOf('MSIE') &&
                n.$root.find('.ngHeaderSortColumn').bind('selectstart', function () {
        ...
        (l.onGroupDrop = function (e) {
          ...
          var i, r;
          l.groupToMove
            ? ((i = t(e.target).closest('.ngGroupElement')),
              'ngGroupPanel' === i.context.className
                ? (o.configGroups.splice(l.groupToMove.index, 1), o.configGroups.push(l.groupToMove.groupName))
                : ((r = angular.element(i).scope()),
                  r &&
                    l.groupToMove.index !== r.$index &&
                    (o.configGroups.splice(l.groupToMove.index, 1), o.configGroups.splice(r.$index, 0, l.groupToMove.groupName))),
              (l.groupToMove = void 0),
              n.fixGroupIndexes())
            : l.colToMove &&
              (-1 === o.configGroups.indexOf(l.colToMove.col) &&
                ((i = t(e.target).closest('.ngGroupElement')),
                'ngGroupPanel' === i.context.className || 'ngGroupPanelDescription ng-binding' === i.context.className
                  ? o.groupBy(l.colToMove.col)
                  : ((r = angular.element(i).scope()), r && o.removeGroup(r.$index))),
              (l.colToMove = void 0)),
            o.$$phase || o.$apply();
        }),
        (l.onHeaderMouseDown = function (e) {
          var n = t(e.target).closest('.ngHeaderSortColumn'),
            o = angular.element(n).scope();
          o && (l.colToMove = { header: n, col: o.col });
        }),
        (l.onHeaderDrop = function (e) {
          if (l.colToMove && !l.colToMove.col.pinned) {
            var r = t(e.target).closest('.ngHeaderSortColumn'),
        ...
        (l.assignGridEventHandlers = function () {
          -1 === n.config.tabIndex
            ? (n.$viewport.attr('tabIndex', i.numberOfGrids), i.numberOfGrids++)
            : n.$viewport.attr('tabIndex', n.config.tabIndex);
          var r;
          t(e).resize(function () {
            clearTimeout(r),
    ...
    y = function (e, t) {
      (e.maxRows = function () {
        ...
        (e.multiSelect = t.config.enableRowSelection && t.config.multiSelect),
        (e.selectedItemCount = t.selectedItemCount),
        (e.maxPages = function () {
    ...
    T = function (i, r, l, a, c, g, d, u, f, p, m) {
      var v = {
        ...
        w = this;
      (w.maxCanvasHt = 0),
        (w.config = t.extend(v, e.ngGrid.config, r)),
        ...
        (w.calcMaxCanvasHeight = function () {
          var e;
          return (e =
            w.config.groups.length > 0
              ? w.rowFactory.parsedData.filter(function (e) {
                  return !e[s];
                }).length * w.config.rowHeight
              : w.filteredRows.length * w.config.rowHeight);
        }),
        (w.elementDims = { scrollW: 0, scrollH: 0, rowIndexCellW: 25, rowSelectedCellW: 25, rootMaxW: 0, rootMaxH: 0 }),
        (w.setRenderedRows = function (e) {
          i.renderedRows.length = e.length;
          for (var t = 0; e.length > t; t++)
            !i.renderedRows[t] || e[t].isAggRow || i.renderedRows[t].isAggRow
              ? ((i.renderedRows[t] = e[t].copy()),
                (i.renderedRows[t].collapsed = e[t].collapsed),
                e[t].isAggRow || i.renderedRows[t].setVars(e[t]))
              : i.renderedRows[t].setVars(e[t]),
              (i.renderedRows[t].rowIndex = e[t].rowIndex),
              (i.renderedRows[t].offsetTop = e[t].offsetTop),
              (i.renderedRows[t].selected = e[t].selected),
              (e[t].renderedRowIndex = t);
        ...
        (w.buildColumns = function () {
          ...
          if (
            ...
            var n = w.config.showSelectionCheckbox ? 1 : 0,
        ...
        (w.configureColumnWidths = function () {
          var e = [],
            ...
            r = {};
          if (
            (angular.forEach(i.columns, function (e, t) {
            ...
            angular.forEach(w.config.columnDefs, function (l, a) {
              ...
              var c,
                g = !1;
              if (
                (d.isNullOrUndefined(l.width)
                  ? (l.width = '*')
                  : ((g = isNaN(l.width) ? d.endsWith(l.width, '%') : !1), (c = g ? l.width : parseInt(l.width, 10))),
                isNaN(c) && !i.hasUserChangedGridColumnWidths)
              ) {
                if (((c = l.width), 'auto' === c)) {
                  (s.width = s.minWidth), (o += s.width);
                  var u = s;
                  return (
                    i.$on('ngGridEventData', function () {
                      w.resizeOnData(u);
                    }),
                    void 0
                  );
            ...
            angular.forEach(t, function (e) {
              var t = i.columns[r[e.index]],
                n = e.width,
                o = parseInt(n.slice(0, -1), 10) / 100;
              (l += o), t.visible || (s += o);
            });
            var c = l - s;
            angular.forEach(t, function (e) {
        ...
        (w.init = function () {
          return w.initTemplates().then(function () {
            (i.selectionProvider = new D(w, i, f)),
              (i.domAccessProvider = new S(w)),
              (w.rowFactory = new R(w, i, a, g, d)),
              (w.searchProvider = new $(i, w, c)),
              (w.styleProvider = new L(i, w)),
              i.$watch(
                'configGroups',
                function (e) {
                  var t = [];
        ...
        (w.resizeOnData = function (e) {
          ...
          angular.forEach(o, function (e, o) {
            ...
            (e.width = e.longest = Math.min(e.maxWidth, n + 7)),
            a.BuildStyles(i, w, !0);
        }),
        (w.lastSortedColumns = []),
        (w.sortData = function (e, n) {
          if (n && n.shiftKey && w.config.sortInfo) {
            var o = w.config.sortInfo.columns.indexOf(e);
            -1 === o
              ? (1 === w.config.sortInfo.columns.length && (w.config.sortInfo.columns[0].sortPriority = 1),
        ...
        (w.sortActual = function () {
          if (!w.config.useExternalSorting) {
            ...
            angular.forEach(e, function (e, t) {
              ...
              angular.forEach(e, function (e, t) {
                (w.rowCache[t].entity = e),
                  (w.rowCache[t].selected = e.preSortSelected),
                  (w.rowMap[e.preSortIndex] = t),
        ...
        (w.clearSortingData = function (e) {
          e
            ? (angular.forEach(w.lastSortedColumns, function (t) {
                e.index !== t.index && ((t.sortDirection = ''), (t.sortPriority = null));
              }),
              (w.lastSortedColumns[0] = e),
              (w.lastSortedColumns.length = 1))
        ...
        (i.adjustScrollLeft = function (e) {
          for (
            var t = 0,
              ...
              o = i.columns.length,
              r = [],
              l = !w.config.enableColumnHeavyVirt,
              s = 0,
              c = function (e) {
        ...
        (i.groupBy = function (e) {
          if (!(1 > w.data.length) && e.groupable && e.field) {
            ...
            -1 === t ? ((e.isGroupedBy = !0), i.configGroups.push(e), (e.groupIndex = i.configGroups.length)) : i.removeGroup(t),
        ...
        (i.togglePin = function (e) {
          ...
          e.pinned && (n = Math.max(e.originalIndex, n - 1)),
            (e.pinned = !e.pinned),
            i.columns.splice(t, 1),
            i.columns.splice(n, 0, e),
            w.fixColumnIndexes(),
            a.BuildStyles(i, w, !0),
        ...
        (i.headerScrollerDim = function () {
          ...
          return (
            ...
            n ? (o.outerWidth += w.elementDims.scrollW) : w.elementDims.scrollH >= t - e && (o.outerWidth += w.elementDims.scrollW),
            o
          );
        });
    },
    ...
    I = function (e, t, n, o, i) {
      (this.entity = e),
        (this.config = t),
        (this.selectionProvider = n),
        (this.rowIndex = o),
        (this.utils = i),
        (this.selected = n.getSelection(e)),
        (this.cursor = this.config.enableRowSelection ? 'pointer' : 'default'),
        (this.beforeSelectionChange = t.beforeSelectionChangeCallback),
        (this.afterSelectionChange = t.afterSelectionChangeCallback),
        (this.offsetTop = this.rowIndex * t.rowHeight),
  ...
  (I.prototype.setSelection = function (e) {
    ...
    (I.prototype.toggleSelected = function (e) {
      ...
      var t = e.target || e;
      return 'checkbox' === t.type && 'ngSelectionCell ng-scope' !== t.parentElement.className
        ? !0
        : this.config.selectWithCheckboxOnly && 'checkbox' !== t.type
        ? ((this.selectionProvider.lastClickedRow = this), !0)
        : (this.beforeSelectionChange(this, e) && this.continueSelection(e), !1);
    }),
    ...
    (I.prototype.copy = function () {
      return (
        (this.clone = new I(this.entity, this.config, this.selectionProvider, this.rowIndex, this.utils)),
  ...
  var R = function (e, t, o, i, r) {
      ...
      (g.aggCache = {}),
        ...
        (g.parsedData = []),
        (g.rowConfig = {}),
        (g.selectionProvider = t.selectionProvider),
        (g.rowHeight = 30),
        ...
        (g.renderedRange = new P(0, e.minRowsToRender() + n)),
        (g.buildEntityRow = function (e, t) {
          return new I(e, g.rowConfig, g.selectionProvider, t, r);
        }),
        (g.buildAggregateRow = function (t, n) {
          var o = g.aggCache[t.aggIndex];
          return (
            o || ((o = new w(t, g, g.rowConfig.rowHeight, e.config.groupsCollapsedByDefault)), (g.aggCache[t.aggIndex] = o)),
            (o.rowIndex = n),
            (o.offsetTop = n * g.rowConfig.rowHeight),
            o
          );
        }),
        ...
        (g.renderedChange = function () {
          ...
          var t = 0,
            n = g.parsedData.filter(function (e) {
        ...
        (g.renderedChangeNoGroups = function () {
          for (var t = [], n = g.renderedRange.topRow; g.renderedRange.bottomRow > n; n++)
            e.filteredRows[n] &&
              ((e.filteredRows[n].rowIndex = n), (e.filteredRows[n].offsetTop = n * e.config.rowHeight), t.push(e.filteredRows[n]));
          e.setRenderedRows(t);
        }),
        (g.fixRowCache = function () {
          var t = e.data.length,
            n = t - e.rowCache.length;
          if (0 > n) e.rowCache.length = e.rowMap.length = t;
          else for (var o = e.rowCache.length; t > o; o++) e.rowCache[o] = e.rowFactory.buildEntityRow(e.data[o], o);
        }),
        (g.parseGroupData = function (e) {
          if (e.values)
            for (var t = 0; e.values.length > t; t++)
              g.parentCache[g.parentCache.length - 1].children.push(e.values[t]), g.parsedData.push(e.values[t]);
          else
            for (var n in e)
    ...
    $ = function (e, n, o) {
      var i = this,
        r = [];
      (i.extFilter = n.config.filterOptions.useExternalFilter),
        (e.showFilter = n.config.showFilter),
        (e.filterText = ''),
        (i.fieldMap = {});
      var l = function (e, t, n) {
        ...
        a = function (e, t) {
          var n,
            r = i.fieldMap[e.columnDisplay];
          if (!r) return !1;
          var l = r.cellFilter.split(':'),
            a = r.cellFilter ? o(l[0]) : null,
    ...
    D = function (e, t, n) {
      ...
      (o.multi = e.config.multiSelect),
        ...
        (o.pKeyParser = n(e.config.primaryKey)),
        (o.ChangeSelection = function (n, i) {
          ...
          if (i && i.shiftKey && !i.keyCode && o.multi && e.config.enableRowSelection) {
            if (o.lastClickedRow) {
              var a;
              a =
                t.configGroups.length > 0
                  ? e.rowFactory.parsedData.filter(function (e) {
                      return !e.isAggRow;
                    })
                  : e.filteredRows;
              var s = n.rowIndex,
            ...
            o.multi
              ? (!i.keyCode || (l && !e.config.selectWithCheckboxOnly)) && o.setSelection(n, !n.selected)
              : o.lastClickedRow === n
              ? o.setSelection(o.lastClickedRow, e.config.keepLastSelected ? !0 : !n.selected)
              : (o.lastClickedRow && o.setSelection(o.lastClickedRow, !1), o.setSelection(n, !n.selected));
          return (o.lastClickedRow = n), (o.lastClickedRowIndex = n.rowIndex), !0;
        }),
          ...
          if (e.config.enableRowSelection) {
            if (n)
              -1 === o.selectedItems.indexOf(t.entity) &&
                (!o.multi && o.selectedItems.length > 0 && o.toggleSelectAll(!1, !0), o.selectedItems.push(t.entity));
            else {
        ...
        (o.toggleSelectAll = function (t, n, i) {
          ...
          if (n || e.config.beforeSelectionChange(r, t)) {
            ...
            for (var a = 0; r.length > a; a++)
              (r[a].selected = t), r[a].clone && (r[a].clone.selected = t), t && o.selectedItems.push(r[a].entity);
  ...
  p.directive('ngCellHasFocus', [
    ...
    function (e) {
      var t = function (t) {
        (t.isFocused = !0),
          e.digest(t),
          t.$broadcast('ngGridEventStartCellEdit'),
          t.$on('ngGridEventEndCellEdit', function () {
            ...
            return (
              e.enableCellEditOnFocus ||
                (o &&
                  ...
                  13 !== i.keyCode &&
                  t(e, n),
                o && i.shiftKey && i.keyCode >= 65 && 90 >= i.keyCode && t(e, n),
                27 === i.keyCode && n.focus()),
              !0
            );
          });
      };
        ...
        var n = {
          ...
          compile: function () {
            return {
              pre: function (t, n) {
                var o,
                  i = t.col.cellTemplate.replace(d, 'row.entity.' + t.col.field);
                t.col.enableCellEdit
                  ? ((o = t.col.cellEditTemplate),
                    (o = o.replace(u, i)),
                    (o = o.replace(f, t.col.editableCellTemplate.replace(d, 'row.entity.' + t.col.field))))
                  : (o = i);
                var r = e(o)(t);
                t.enableCellSelection &&
                  -1 === r[0].className.indexOf('ngSelectionCell') &&
                  (r[0].setAttribute('tabindex', 0), r.addClass('ngCellElement')),
                  n.append(r);
              },
              post: function (e, n) {
            ...
            return {
              pre: function (d, u, f) {
                ...
                return m.init().then(function () {
                  if (
                    ('string' == typeof p.columnDefs
                      ? d.$parent.$watch(
                          p.columnDefs,
                          function (e) {
                            return e
                              ? ((m.lateBoundColumns = !1),
                                (d.columns = []),
                                ...
                                r.RebuildGrid(d, m),
                                void 0)
                              : (m.refreshDomSizes(), m.buildColumns(), void 0);
                          },
                          !0
                        )
                      : m.buildColumns(),
                    'string' == typeof p.totalServerItems
                      ? d.$parent.$watch(p.totalServerItems, function (e) {
                    ...
                    var n = function (e) {
                      (m.data = t.extend([], e)),
                        ...
                        angular.forEach(m.data, function (e, t) {
                          var n = m.rowMap[t] || t;
                    ...
                    d.$parent.$watch(p.data, n),
                      d.$parent.$watch(p.data + '.length', function () {
                        n(d.$eval(p.data));
                      });
                  }
                  return (
                    (m.footerController = new y(d, m)),
                    ...
                    (m.eventProvider = new x(m, d, r, a)),
                    (p.selectRow = function (e, t) {
                      m.rowCache[e] &&
                        (m.rowCache[e].clone && m.rowCache[e].clone.setSelection(t ? !0 : !1), m.rowCache[e].setSelection(t ? !0 : !1));
                    }),
                    ...
                    (p.ngGrid = m),
                    (p.$gridScope = d),
                    (p.$gridServices = { SortService: i, DomUtilityService: r, UtilityService: l }),
            ...
            t.bind('keydown', function (n) {
              switch (n.keyCode) {
                ...
                case 27:
                  ...
                  break;
                case 13:
                  ((e.enableCellEditOnFocus && e.totalFilteredItemsLength() - 1 > e.row.rowIndex && e.row.rowIndex > 0) ||
                    e.enableCellEdit) &&
                    t.blur();
              }
              return !0;
      ...
      function () {
        return function (e, t) {
          ...
          t.bind('scroll', function (t) {
            var r = t.target.scrollLeft,
              l = t.target.scrollTop;
            return (
              e.$headerContainer && e.$headerContainer.scrollLeft(r),
      ...
      function (e) {
        e.put(
          ...
          e.put(
            ...
            '<div ng-cell-has-focus ng-dblclick="editCell()">	<div ng-edit-cell-if="!isFocused">			DISPLAY_CELL_TEMPLATE	</div>	<div ng-edit-cell-if="isFocused">		EDITABLE_CELL_TEMPLATE	</div></div>'
          ),
          e.put(
            'cellTemplate.html',
