...
angular.module('pascalprecht.translate', ['ng']).run([
  ...
  function (a) {
    ...
    c
      ? c.get(b)
        ? a.use(c.get(b))
        : angular.isString(a.preferredLanguage())
        ? a.use(a.preferredLanguage())
        : c.set(b, a.use())
      : angular.isString(a.preferredLanguage()) && a.use(a.preferredLanguage());
  },
]),
    ...
    function (a) {
      var b,
        ...
        z = function () {
          ...
          return (
            (angular.isArray(a.languages) ? a.languages[0] : a.language || a.browserLanguage || a.systemLanguage || a.userLanguage) || ''
          )
            .split('-')
            .join('_');
        },
        ...
        C = function (a) {
          ...
          if (c) {
            ...
            for (var h in c) {
              ...
              if (
                ('*' === h.slice(-1) && (i = h.slice(0, -1) === a.slice(0, h.length - 1)),
                (j || i) && ((g = c[h]), A(b, angular.lowercase(g)) > -1))
              )
                return g;
            }
          }
      ...
      var E = function (a, b, c, d) {
        ...
        for (e in a)
          Object.prototype.hasOwnProperty.call(a, e) &&
            ...
            angular.isObject(h)
              ? E(h, b.concat(e), c, e)
              : ((f = b.length ? '' + b.join(x) + x + e : e),
                b.length && e === d && ((g = '' + b.join(x)), (c[g] = '@:' + f)),
                (c[f] = h)));
        return c;
      };
      ...
      var G = function (a) {
        return a
          ? (angular.isString(a) ? ((e = !0), (d = [a])) : angular.isArray(a) && ((e = !1), (d = a)),
            angular.isString(b) && A(d, b) < 0 && d.push(b),
            this)
          : e
          ? d[0]
          : d;
        ...
        (this.$get = [
          ...
          function (a, c, i, r) {
            var x,
              z,
              I,
              J = c.get(k || '$translateDefaultInterpolation'),
              K = !1,
              L = {},
              M = {},
              N = function (a, c, e) {
              ...
              P = function (a) {
                (f = a),
                  i.$emit('$translateChangeSuccess', { language: a }),
                  h && x.set(N.storageKey(), f),
                  J.setLocale(f),
                ...
                return (
                  c
                    ...
                    .then(
                      function (c) {
                        var d = {};
                        i.$emit('$translateLoadingSuccess', { language: a }),
                          angular.isArray(c)
                            ? angular.forEach(c, function (a) {
                                angular.extend(d, E(a));
                              })
                            : angular.extend(d, E(c)),
                          (K = !1),
                          b.resolve({ key: a, table: d }),
            ...
            if (h && ((x = c.get(h)), !x.get || !x.set))
              throw new Error("Couldn't use storage '" + h + "', missing get() or set() method!");
            angular.isFunction(J.useSanitizeValueStrategy) && J.useSanitizeValueStrategy(u),
              t.length &&
                angular.forEach(t, function (a) {
                  var d = c.get(a);
                  d.setLocale(b || f),
                    angular.isFunction(d.useSanitizeValueStrategy) && d.useSanitizeValueStrategy(u),
                    (L[d.getInterpolationIdentifier()] = d);
                });
            var R = function (a) {
                var b = r.defer();
                return (
                ...
                return (
                  R(a).then(function (g) {
                    Object.prototype.hasOwnProperty.call(g, b)
                      ? (d.setLocale(a), e.resolve(d.interpolate(g[b], c)), d.setLocale(f))
                      : e.reject();
                  }, e.reject),
                  e.promise
                );
            ...
            if (
              ((N.preferredLanguage = function (a) {
                return a && F(a), b;
              }),
                  ...
                  q[a] || !l || M[a]
                    ...
                    : ((g = a),
                      (M[a] = Q(a).then(
                        ...
                        function (a) {
                          g === a && (g = void 0),
                            i.$emit('$translateChangeError', { language: a }),
                            b.reject(a),
                            i.$emit('$translateChangeEnd', { language: a });
                        }
                      ))),
        ...
        compile: function (b, g) {
          ...
          return function (b, l, m) {
            if (
              ...
              h &&
                m.$observe('translateValues', function (a) {
                  a &&
                    b.$parent.$watch(function () {
              ...
              for (var o in m)
                Object.prototype.hasOwnProperty.call(m, o) && 'translateValue' === o.substr(0, 14) && 'translateValues' !== o && n(o);
            }
                ...
                return h || j
                  ? function () {
                      var c = function () {
                        b.translationId &&
                          b.interpolateParams &&
                          a(b.translationId, b.interpolateParams, i).then(
                            function (a) {
                              p(a, b, !0);
                            },
                            function (a) {
          ...
          return (
            ...
            function (a, c, f) {
              f.translateCloak &&
                ...
                f.$observe('translateCloak', function (a) {
                  b(a).then(e, d);
                });
            }
          );
