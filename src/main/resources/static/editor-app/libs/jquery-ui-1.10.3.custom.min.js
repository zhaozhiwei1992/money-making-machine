            ...
            ? ((l[i] = (function () {
                ...
                return function () {
                  var i,
                    ...
                    a = this._superApply;
                  return (
                    (this._super = e), (this._superApply = t), (i = n.apply(this, arguments)), (this._super = s), (this._superApply = a), i
                  );
                };
              })()),
              t)
        ...
        for (n in r[o])
          (a = r[o][n]),
            r[o].hasOwnProperty(n) &&
              a !== t &&
              (i[n] = e.isPlainObject(a) ? (e.isPlainObject(i[n]) ? e.widget.extend({}, i[n], a) : e.widget.extend({}, a)) : a);
      return i;
    }),
            ...
            ? this.each(function () {
                ...
                return n
                  ? e.isFunction(n[r]) && '_' !== r.charAt(0)
                    ? ((s = n[r].apply(n, h)), s !== n && s !== t ? ((l = s && s.jquery ? l.pushStack(s.get()) : s), !1) : t)
  ...
  e.widget('ui.draggable', e.ui.mouse, {
    ...
    _convertPositionTo: function (t, i) {
      ...
      var s = 'absolute' === t ? 1 : -1,
        n =
          'absolute' !== this.cssPosition || (this.scrollParent[0] !== document && e.contains(this.scrollParent[0], this.offsetParent[0]))
            ? this.scrollParent
            : this.offsetParent;
      return (
        this.offset.scroll || (this.offset.scroll = { top: n.scrollTop(), left: n.scrollLeft() }),
        {
          top:
            ...
            ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : this.offset.scroll.top) * s,
          left:
            i.left +
            this.offset.relative.left * s +
            this.offset.parent.left * s -
            ('fixed' === this.cssPosition ? -this.scrollParent.scrollLeft() : this.offset.scroll.left) * s,
        }
      );
    },
      ...
      start: function (t, i) {
        ...
        (s.sortables = []),
          e(n.connectToSortable).each(function () {
            ...
            i &&
              !i.options.disabled &&
              (s.sortables.push({ instance: i, shouldRevert: i.options.revert }), i.refreshPositions(), i._trigger('activate', t, a));
          });
      },
      stop: function (t, i) {
        var s = e(this).data('ui-draggable'),
        ...
        (t.snapElements = []),
          e(i.snap.constructor !== String ? i.snap.items || ':data(ui-draggable)' : i.snap).each(function () {
            var i = e(this),
              s = i.offset();
            this !== t.element[0] &&
              t.snapElements.push({ item: this, width: i.outerWidth(), height: i.outerHeight(), top: s.top, left: s.left });
          });
      },
      drag: function (t, i) {
        var s,
        ...
        for (c = p.snapElements.length - 1; c >= 0; c--)
          (r = p.snapElements[c].left),
            ...
            r - m > v || g > h + m || l - m > y || b > u + m || !e.contains(p.snapElements[c].item.ownerDocument, p.snapElements[c].item)
              ? (p.snapElements[c].snapping &&
                  p.options.snap.release &&
                  p.options.snap.release.call(p.element, t, e.extend(p._uiHash(), { snapItem: p.snapElements[c].item })),
              ...
              : ('inner' !== f.snapMode &&
                  ...
                  s &&
                    (i.position.top =
                      p._convertPositionTo('relative', { top: l - p.helperProportions.height, left: 0 }).top - p.margins.top),
                  n && (i.position.top = p._convertPositionTo('relative', { top: u, left: 0 }).top - p.margins.top),
                  a &&
                    (i.position.left =
                      p._convertPositionTo('relative', { top: 0, left: r - p.helperProportions.width }).left - p.margins.left),
                ...
                'outer' !== f.snapMode &&
                  ...
                  n &&
                    (i.position.top =
                      p._convertPositionTo('relative', { top: u - p.helperProportions.height, left: 0 }).top - p.margins.top),
                  a && (i.position.left = p._convertPositionTo('relative', { top: 0, left: r }).left - p.margins.left),
                  o &&
                    (i.position.left =
                      p._convertPositionTo('relative', { top: 0, left: h - p.helperProportions.width }).left - p.margins.left)),
                !p.snapElements[c].snapping &&
                  (s || n || a || o || d) &&
                  p.options.snap.snap &&
  ...
  e.widget('ui.droppable', {
    ...
    (e.ui.intersect = function (e, i, s) {
      ...
      switch (s) {
        ...
        case 'touch':
          return (
            ((h >= d && p >= h) || (l >= d && p >= l) || (d > h && l > p)) && ((o >= u && c >= o) || (r >= u && c >= r) || (u > o && r > c))
          );
        default:
          return !1;
      }
      ...
      resize: function () {
        ...
        (i.grid = r),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : ((t.size.width = d), (t.size.height = p), (t.position.top = a.top - c), (t.position.left = a.left - u));
      },
    });
})(jQuery);
(function (e) {
            ...
            i &&
              ...
              l
                ? (i.selected && (i.$element.removeClass('ui-selected'), (i.selected = !1)),
                  ...
                  i.selecting ||
                    (i.$element.addClass('ui-selecting'), (i.selecting = !0), s._trigger('selecting', t, { selecting: i.element })))
                : (i.selecting &&
  ...
  t.widget('ui.sortable', t.ui.mouse, {
        ...
        if (1 === this.containers.length)
          ...
          for (
            ...
            t.contains(this.containers[m].element[0], this.items[a].item[0]) &&
              ...
              o > Math.abs(u - c) && ((o = Math.abs(u - c)), (r = this.items[a]), (this.direction = d ? 'up' : 'down')));
    ...
    _convertPositionTo: function (e, i) {
      ...
      var s = 'absolute' === e ? 1 : -1,
        n =
          'absolute' !== this.cssPosition || (this.scrollParent[0] !== document && t.contains(this.scrollParent[0], this.offsetParent[0]))
            ? this.scrollParent
            : this.offsetParent,
