...
(function () {
  ...
  (function (G) {
    function m(a) {
      ...
      else if ('json' == a) c = m('json-stringify') && m('json-parse');
      else {
        var e;
        if ('json-stringify' == a) {
          c = o.stringify;
      ...
      if (!m('json-stringify')) {
            ...
            if (typeof h == 'object' && h) {
              ...
              if (k == '[object Date]' && !q.call(h, 'toJSON'))
                if (h > -1 / 0 && h < 1 / 0) {
                  ...
                  h =
                    (k <= 0 || k >= 1e4 ? (k < 0 ? '-' : '+') + v(6, k < 0 ? -k : k) : v(4, k)) +
                    '-' +
                    v(2, i + 1) +
                    '-' +
                    v(2, l) +
                ...
                ((k != '[object Number]' && k != '[object String]' && k != '[object Array]') || q.call(h, 'toJSON'))
              )
                h = h.toJSON(a);
            }
            b && (h = b.call(c, a, h));
        ...
        o.stringify = function (a, c, b) {
          ...
          if (typeof c == 'function' || (typeof c == 'object' && c))
            if ((d = p.call(c)) == '[object Function]') f = c;
            else if (d == '[object Array]') {
              j = {};
              for (
                var h = 0, k = c.length, i;
                h < k;
                i = c[h++], ((d = p.call(i)), d == '[object String]' || d == '[object Number]') && (j[i] = 1)
              );
            }
          if (b)
        ...
        var L = String.fromCharCode,
            ...
            for (var a = A, c = a.length, e, g, f, j, d; b < c; ) {
              ...
              switch (d) {
                ...
                default:
                  ...
                  if (d >= 48 && d <= 57) {
                    for (
                      d == 48 && ((d = a.charCodeAt(b + 1)), d >= 48 && d <= 57) && i();
                      b < c && ((d = a.charCodeAt(b)), d >= 48 && d <= 57);
                      b++
                    );
          ...
          E = function (a, b, e) {
            ...
            if (typeof g == 'object' && g)
              if (p.call(g) == '[object Array]') for (f = g.length; f--; ) F(g, f, e);
              else
                x(g, function (a) {
                  F(g, a, e);
                });
