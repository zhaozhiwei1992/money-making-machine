...
import com.example.service.DatabaseMetaService;
...
public class CommonSqlRepository extends JdbcDaoSupport {
     ...
     * @Description: 描述
     */
    public int updateAllByPK(String tableName, String pkcolumn, Collection<? extends Map> datas, Collection<String> columns) {
        ...
        log.debug("sql:{}  :: {}", sb, updateParamArrList.toString());
        try {
            this.getJdbcTemplate()
                .batchUpdate(
                    sb.toString(),
