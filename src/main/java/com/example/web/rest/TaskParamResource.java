...
/**
 * REST controller for managing {@link com.example.domain.TaskParam}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TaskParamResource {
    ...
    public ResponseEntity<List<TaskParam>> getAllTaskParams(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
